...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> kafka(KafkaException e) {
        log.error("Kafka failure: {}", e.getMessage());
        return error(HttpStatus.SERVICE_UNAVAILABLE, "kafka_unavailable", e.getMessage());
    }
